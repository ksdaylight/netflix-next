            ...
            <div className="relative w-auto max-w-3xl mx-auto overflow-hidden rounded md">
                <div className={`${isVisible ? 'scale-100' : 'scale-0'} transform duration-300 relative flex-auto bg-zinc-900 drop-shadow-md`}>
                    <div className="relative h-96">
                        ...
                        <video src={data?.videoUrl} poster={data?.thumbnailUrl} className="w-full brightness-[50%] object-cover h-full" autoPlay muted loop></video>
                        <div onClick={handleClose} className="absolute flex items-center justify-center w-10 h-10 rounded-full cursor-pointer bg-black/70 top-3 right-3">
